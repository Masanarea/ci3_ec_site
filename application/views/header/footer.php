<footer>
								...
								<div class="row">
									<div class="col-sm-5 col-lg-6">
										<div class="product-main-image">
											<img src="<?php echo base_url('assets/assets/theme/images/product/product-big-1.jpg')?>" alt="" />
										</div>
									</div>
										...
										<div class="product-info">
											...
											<div class="wrapper">
												...
												<ul class="options-swatch-texture">
													<li><a href="#"><img src="<?php echo base_url("assets/assets/theme/images/custom/texture-img-01.jpg")?>" alt=""></a></li>
													<li><a href="#"><img src="<?php echo base_url("assets/assets/theme/images/custom/texture-img-02.jpg")?>" alt=""></a></li>
													<li><a href="#"><img src="<?php echo base_url("assets/assets/theme/images/custom/texture-img-03.jpg")?>" alt=""></a></li>
												</ul>
											</div>
											<div class="wrapper">
		...
		<div class="modal-compare">
			<div class="container">
				...
				<div class="row-content">
					<div class="item">
						<a href="#" class="img"><img src="<?php echo base_url("assets/assets/theme/images/product/product-01.jpg")?>" alt=""/></a>
		...
		<!-- /modalWishlist -->
		<script src="<?php echo base_url("assets/assets/theme/external/jquery/jquery-2.1.4.min.js")?>"></script>
		<script src="<?php echo base_url("assets/assets/theme/external/bootstrap/bootstrap.min.js")?>"></script>
		<script src="<?php echo base_url("assets/assets/theme/external/countdown/jquery.plugin.min.js")?>"></script>
		<script src="<?php echo base_url("assets/assets/theme/external/countdown/jquery.countdown.min.js")?>"></script>
		<script src="<?php echo base_url("assets/assets/theme/external/isotope/isotope.pkgd.min.js")?>"></script>
		<script src="<?php echo base_url("assets/assets/theme/external/slick/slick.min.js")?>"></script>
		<script src="<?php echo base_url("assets/assets/theme/external/instafeed/instafeed.min.js")?>"></script>
		<script src="<?php echo base_url("assets/assets/theme/external/elevatezoom/jquery.elevatezoom.js")?>"></script>
		<script src="<?php echo base_url("assets/assets/theme/external/magnific-popup/jquery.magnific-popup.min.js")?>"></script>
		<script src="<?php echo base_url("assets/assets/theme/external/panelmenu/panelmenu.js")?>"></script>
		<script src="<?php echo base_url("assets/assets/theme/js/main.js")?>"></script>